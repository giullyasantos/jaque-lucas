...
const Home = () => {
  ...
  useEffect(() => {
    preloadImages([coupleDesktop, coupleMobile]).then(() => setIsLoading(false));
  }, []);
  ...
  return (
    <section className="home-container fade-in">
      <div className="home-content">
        ...
        {/* Opening verse — words stagger in */}
        <p
          ref={verseRef}
          className={`home-verse reveal-stagger${verseVisible ? ' is-visible' : ''}`}
        >
        ...
        {/* Divider 1 */}
        <div ref={div1Ref} className={`home-divider-ornament reveal-divider${div1Visible ? ' is-visible' : ''}`}>
          <span /><svg viewBox="0 0 10 10"><polygon points="5,1 9,5 5,9 1,5" fill="none" stroke="currentColor" strokeWidth="1"/></svg><span />
        </div>
        ...
        {/* Parents insert card — envelope unfold */}
        ...
        {/* Divider 2 */}
        <div ref={div2Ref} className={`home-divider-ornament reveal-divider${div2Visible ? ' is-visible' : ''}`}>
          <span /><svg viewBox="0 0 10 10"><polygon points="5,1 9,5 5,9 1,5" fill="none" stroke="currentColor" strokeWidth="1"/></svg><span />
        </div>

        {/* Couple names — untouched */}
        <h1 className="home-couple">Jaqueline & Lucas</h1>
        <p className="home-invite">convidam para o seu casamento</p>

        {/* Date block — untouched */}
        ...
        {/* Divider */}
        <div className="home-divider-ornament">
          <span /><svg viewBox="0 0 10 10"><polygon points="5,1 9,5 5,9 1,5" fill="none" stroke="currentColor" strokeWidth="1"/></svg><span />
        </div>
